...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Personnel Registration') }}</div>

                <div class="card-body">
                    <form method="POST" action="{{ route('createpersonnel') }}">
                        @csrf

                        <div class="row mb-3">
                            <label for="work_id" class="col-md-4 col-form-label text-md-end">{{ __('Work ID') }}</label>
